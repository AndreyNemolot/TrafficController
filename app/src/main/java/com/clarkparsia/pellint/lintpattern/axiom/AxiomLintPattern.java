 ...
 * </p>
 * <p>
 * Description: Provides convenience (protected) methods to create and set {@link Lint},
...
public abstract class AxiomLintPattern extends OWLAxiomVisitorAdapter implements LintPattern {
	...
	/**
	 * Match an OWLAxiom and returns a {@link Lint}
	 * for the axiom if found.
	 * Do not override this method.
	 * To create and return a {@link Lint}, implementers of this class should
	 * call {@link #makeLint()} first, set any necessary information on the {@link Lint},
	 * and lastly call {@link #setLint(Lint)}.
	 * 
	 * @return {@link Lint} for the OWLAxiom, otherwise <code>null</code>.
	 * 
	 * @see Lint
	 */
