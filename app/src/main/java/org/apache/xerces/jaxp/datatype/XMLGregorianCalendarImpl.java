...
/**
 * <p>
 * Representation for W3C XML Schema 1.0 date/time datatypes. Specifically,
 * these date/time datatypes are {@link DatatypeConstants#DATETIME dateTime},
 * {@link DatatypeConstants#TIME time}, {@link DatatypeConstants#DATE date},
 * {@link DatatypeConstants#GYEARMONTH gYearMonth},
 * {@link DatatypeConstants#GMONTHDAY gMonthDay},
 * {@link DatatypeConstants#GYEAR gYear}, {@link DatatypeConstants#GMONTH
 * gMonth} and {@link DatatypeConstants#GDAY gDay} defined in the XML Namespace
 * <code>"http://www.w3.org/2001/XMLSchema"</code>. These datatypes are
 * normatively defined in <a
 * href="http://www.w3.org/TR/xmlschema-2/#dateTime">W3C XML Schema 1.0 Part 2,
 * Section 3.2.7-14</a>.
 * </p>
 * 
 * <p>
 * The table below defines the mapping between XML Schema 1.0 date/time datatype
 * fields and this class' fields. It also summarizes the value constraints for
 * the date and time fields defined in <a
 * href="http://www.w3.org/TR/xmlschema-2/#isoformats">W3C XML Schema 1.0 Part
 * 2, Appendix D, <i>ISO 8601 Date and Time Formats</i></a>.
 * </p>
 * 
 ...
 * {@link #getEonAndYear}</td>
 * <td> <code>getYear()</code> is a value between -(10^9-1) to (10^9)-1 or
 * {@link DatatypeConstants#FIELD_UNDEFINED}.<br/>
 * {@link #getEon()} is high order year value in billion of years.<br/>
 * <code>getEon()</code> has values greater than or equal to (10^9) or less than
 * or equal to -(10^9). A value of null indicates field is undefined.</br> Given
 * that <a href="http://www.w3.org/2001/05/xmlschema-errata#e2-63">XML Schema
 * 1.0 errata</a> states that the year zero will be a valid lexical value in a
 * future version of XML Schema, this class allows the year field to be set to
 * zero. Otherwise, the year field value is handled exactly as described in the
 * errata and [ISO-8601-1988]. Note that W3C XML Schema 1.0 validation does not
 * allow for the year field to have a value of zero.</td>
 * </tr>
 ...
 * <td>day</td>
 * <td> {@link #getDay()}</td>
 * <td>Independent of month, max range is 1 to 31 or
 * {@link DatatypeConstants#FIELD_UNDEFINED}.<br/>
 ...
 * <td> {@link #getHour()}</td>
 * <td>
 * 0 to 24 or {@link DatatypeConstants#FIELD_UNDEFINED} <a
 * href="http://www.w3.org/2001/05/xmlschema-errata#e2-45">For a value of 24,
 * the minute and second field must be zero.</a></td>
 * </tr>
 ...
 * {@link #getSecond()} + {@link #getFractionalSecond()}</td>
 * <td>
 * {@link #getSecond()} from 0 to 60 or
 * {@link DatatypeConstants#FIELD_UNDEFINED}.<br/>
 * <i>(Note: 60 only allowable for leap second.)</i><br/>
 * {@link #getFractionalSecond()} allows for infinite precision over the range
 * from 0.0 to 1.0 when the {@link #getSecond()} is defined.<br/>
 * <code>FractionalSecond</code> is optional and has a value of
 * <code>null</code> when it is undefined.<br />
 * {@link #getMillisecond()} is the convenience millisecond precision of value
 * of {@link #getFractionalSecond()}.</td>
 * </tr>
 * <tr id="datetimefield-timezone">
 * <td>timezone</td>
 * <td> {@link #getTimezone()}</td>
 * <td>Number of minutes or {@link DatatypeConstants#FIELD_UNDEFINED}. Value
 * range from -14 hours (-14 * 60 minutes) to 14 hours (14 * 60 minutes).</td>
 * </tr>
 * </tbody>
 * </table>
 * 
 ...
 * are checked by factory methods, setter methods and parse methods of this
 * class. <code>IllegalArgumentException</code> is thrown when parameter's value
 * is outside the maximum value constraint for the field. Validation checks, for
 * example, whether days in month should be limited to 29, 30 or 31 days, that
 * are dependent on the values of other fields are not checked by these methods.
 * </p>
 * 
 * <p>
 ...
 * <li>conversion between this class and W3C XML Schema 1.0 lexical
 * representation</li>
 * <li>conversion between this class and
 * <code>java.util.GregorianCalendar</code></li>
 * <li>partial order relation comparator method,
 * {@link #compare(XMLGregorianCalendar)}</li>
 * <li>{@link #equals(Object)} defined relative to
 * {@link #compare(XMLGregorianCalendar)}.</li>
 * <li>addition operation with {@link Duration}. instance as
 * defined in <a
 * href="http://www.w3.org/TR/xmlschema-2/#adding-durations-to-dateTimes"> W3C
 * XML Schema 1.0 Part 2, Appendix E, <i>Adding durations to dateTimes</i></a>.</li>
 * </ul>
 * </p>
 * 
 * @author <a href="mailto:Kohsuke.Kawaguchi@Sun.com">Kohsuke Kawaguchi</a>
 * @author <a href="mailto:Joseph.Fialli@Sun.com">Joseph Fialli</a>
 * @version $Id: XMLGregorianCalendarImpl.java 759809 2009-03-30 00:44:05Z
 *          mrglavas $
 * @see Duration
 */
class XMLGregorianCalendarImpl extends XMLGregorianCalendar implements
	 ...
	 */
	private static final int MIN_FIELD_VALUE[] = { Integer.MIN_VALUE, // Year
																		// field
																		// can
																		// be
																		// smaller
			...
			DatatypeConstants.JANUARY, 1, // day of month
			0, // hour
			0, // minute
			0, // second
			0, // millisecond
	 ...
	 */
	private static final int MAX_FIELD_VALUE[] = { Integer.MAX_VALUE, // Year
																		// field
																		// can
																		// be
																		// bigger
																		...
																		// this,
			// only constraint on integer value of year.
			DatatypeConstants.DECEMBER, 31, // day of month
			24, // hour
			59, // minute
	 ...
	 */
	private static final String FIELD_NAME[] = { "Year", "Month", "Day",
			"Hour", "Minute", "Second", "Millisecond", "Timezone" };

	/**
	 * <p>
	 * Use as a template for default field values when converting to a
	 * {@link GregorianCalendar}, set to a leap year date of January 1, 0400 at
	 * midnight.
	 * </p>
	 * 
	 * <p>
	 * Fields that are optional for an <code>xsd:dateTime</code> instances are
	 * defaulted to not being set to any value.
	 * <code>XMLGregorianCalendar</code> fields millisecond, fractional second
	 * and timezone return the value indicating that the field is not set,
	 * {@link DatatypeConstants#FIELD_UNDEFINED} for millisecond and timezone
	 * and <code>null</code> for fractional second.
	 * </p>
	 * 
	 * @see #toGregorianCalendar(TimeZone, Locale, XMLGregorianCalendar)
	 */
	public static final XMLGregorianCalendar LEAP_YEAR_DEFAULT = createDateTime(
			400, // year
	...
	protected XMLGregorianCalendarImpl(String lexicalRepresentation)
		...
		if (lexRep.indexOf('T') != NOT_FOUND) {
			...
			if (lexRepLength >= 3 && lexRep.charAt(2) == '-') {
				...
				format = "---%D" + "%z";
					...
					|| (lexRepLength >= 6 && (lexRep.charAt(4) == '+' || (lexRep
							.charAt(4) == '-' && (lexRep.charAt(5) == '-' || lexRepLength == 10))))) {
				// GMonth
				// Fix 4971612: invalid SCCS macro substitution in data string
				format = "--%M--%z";
		...
		// check for validity
		if (!isValid()) {
			throw new IllegalArgumentException("InvalidXGCRepresentation");
		}
		save();
	}
	...
	/**
	 * <p>
	 * Private constructor allowing for complete value spaces allowed by W3C XML
	 * Schema 1.0 recommendation for xsd:dateTime and related builtin datatypes.
	 * Note that <code>year</code> parameter supports arbitrarily large numbers
	 * and fractionalSecond has infinite precision.
	 * </p>
	 * 
	 * @param year
	 ...
	 * 
	 */
	protected XMLGregorianCalendarImpl(BigInteger year, int month, int day,
		...
		if (!isValid()) {
			...
			throw new IllegalArgumentException("InvalidXGCValue-fractional");

			/**
			 * String yearString = "null"; if (year != null) { yearString =
			 * year.toString(); } String fractionalSecondString = "null"; if
			 * (fractionalSecond != null) { fractionalSecondString =
			 * fractionalSecond.toString(); }
			 * 
			 * throw new IllegalArgumentException( "year = " + yearString +
	 ...
	 * <code>java.util.GregorianCalendar</code> instance would need to convert
	 * to an <code>XMLGregorianCalendar</code> instance.
	 * </p>
	 * 
	 * <p>
	 * <code>XMLGregorianCalendar eon</code> and <code>fractionalSecond</code>
	 ...
	 *            of <code>XMLGregorianCalendar</code> to be created.
	 */
	private XMLGregorianCalendarImpl(int year, int month, int day, int hour,
		...
		if (!isValid()) {
			...
			throw new IllegalArgumentException("InvalidXGCValue-milli");
			/*
	...
	/**
	 * <p>
	 * Convert a <code>java.util.GregorianCalendar</code> to XML Schema 1.0
	 * representation.
	 * </p>
	 * 
	 * <table border="2" rules="all" cellpadding="2">
	 ...
	 * Field by Field Conversion from <code>java.util.GregorianCalendar</code>
	 * to this class</th>
	 * </tr>
	 * </thead> <tbody>
	 * <tr>
	 ...
	 * </table>
	 * <p>
	 * <i>*</i>conversion loss of information. It is not possible to represent a
	 * <code>java.util.GregorianCalendar</code> daylight savings timezone id in
	 * the XML Schema 1.0 date/time datatype representation.
	 * </p>
	 * 
	 * <p>
	 ...
	 * <ul>
	 * <li>when
	 * <code>this.getTimezone() != DatatypeConstants.FIELD_UNDEFINED</code>,
	 * create a <code>java.util.TimeZone</code> with a custom timezone id using
	...
	public XMLGregorianCalendarImpl(GregorianCalendar cal) {
		...
		this.setTime(cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE),
	 ...
	 * <code>dateTime</code>. All possible fields are specified for this factory
	 * method.
	 * </p>
	 * 
	 * @param year
	...
	public static XMLGregorianCalendar createDateTime(BigInteger year,
		...
		return new XMLGregorianCalendarImpl(year, month, day, hours, minutes,
				seconds, fractionalSecond, timezone);
	}
	 ...
	 * @see DatatypeConstants#FIELD_UNDEFINED
	 */
	public static XMLGregorianCalendar createDateTime(int year, int month,
			int day, int hour, int minute, int second) {

		return new XMLGregorianCalendarImpl(year, month, day, hour, minute,
				second, DatatypeConstants.FIELD_UNDEFINED, // millisecond
				DatatypeConstants.FIELD_UNDEFINED // timezone
		);
	}
	 ...
	 * @param milliseconds
	 *            of <code>dateTime</code>.
	 *            {@link DatatypeConstants#FIELD_UNDEFINED} indicates optional
	 *            field is not set.
	 * @param timezone
	 *            offset in minutes. {@link DatatypeConstants#FIELD_UNDEFINED}
	 *            indicates optional field is not set.
	 ...
	 * 
	 * <p>
	 * For example, an instance of <code>gYear</code> can be created invoking
	 * this factory with <code>month</code> and <code>day</code> parameters set
	 * to {@link DatatypeConstants#FIELD_UNDEFINED}.
	 * </p>
	 * 
	 * @param year
	 *            of <code>XMLGregorianCalendar</code> to be created.
	...
	public static XMLGregorianCalendar createDate(int year, int month, int day,
		...
		return new XMLGregorianCalendarImpl(year, month, day,
	 ...
	 *             field mapping table</a>.
	 */
	public static XMLGregorianCalendar createTime(int hours, int minutes,
			int seconds, int timezone) {

		return new XMLGregorianCalendarImpl(DatatypeConstants.FIELD_UNDEFINED, // Year
				DatatypeConstants.FIELD_UNDEFINED, // Month
				DatatypeConstants.FIELD_UNDEFINED, // Day
				hours, minutes, seconds, DatatypeConstants.FIELD_UNDEFINED, // Millisecond
				timezone);
	}
	 ...
	 *            number of seconds
	 * @param fractionalSecond
	 *            value of <code>null</code> indicates that this optional field
	 *            is not set.
	 * @param timezone
	 *            offset in minutes. {@link DatatypeConstants#FIELD_UNDEFINED}
	 *            indicates optional field is not set.
	...
	public static XMLGregorianCalendar createTime(int hours, int minutes,
		...
		return new XMLGregorianCalendarImpl(null, // Year
				DatatypeConstants.FIELD_UNDEFINED, // month
				DatatypeConstants.FIELD_UNDEFINED, // day
	...
	/**
	 * <p>
	 * Return high order component for XML Schema 1.0 dateTime datatype field
	 * for <code>year</code>. <code>null</code> if this optional part of the
	 * year field is not defined.
	 * </p>
	 * 
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-year">year field of date/time field mapping
	 * table</a>.
	 * </p>
	 * 
	 * @return eon of this <code>XMLGregorianCalendar</code>. The value returned
	 *         is an integer multiple of 10^9.
	 * 
	 * @see #getYear()
	 * @see #getEonAndYear()
	 */
	 ...
	 * <code>year</code> or {@link DatatypeConstants#FIELD_UNDEFINED}.
	 * </p>
	 * 
	 * <p>
	 * Value constraints for this value are summarized in <a
	 ...
	 *         when both fields are defined. When only <code>year</code> is
	 *         defined, return it. When both <code>eon</code> and
	 ...
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-month">month field of date/time field mapping
	 * table</a>.
	 * </p>
	 * 
	 * @return year of this <code>XMLGregorianCalendar</code>.
	 ...
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-day">day field of date/time field mapping table</a>.
	 * </p>
	 * 
	 * @see #setDay(int)
	 */
	 ...
	 * {@link DatatypeConstants#FIELD_UNDEFINED} if this optional field is not
	 * defined.
	 * 
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-timezone">timezone field of date/time field mapping
	 * table</a>.
	 * </p>
	 * 
	 * @see #setTimezone(int)
	...
	/**
	 * Return hours or {@link DatatypeConstants#FIELD_UNDEFINED}. Returns
	 * {@link DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
	 * 
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-hour">hour field of date/time field mapping
	 * table</a>.
	 * </p>
	 * 
	...
	/**
	 * Return minutes or {@link DatatypeConstants#FIELD_UNDEFINED}.<\p> Returns
	 * {@link DatatypeConstants#FIELD_UNDEFINED} if this field is not defined.
	 * 
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-minute">minute field of date/time field mapping
	 * table</a>.
	 * </p>
	 * 
	 * @see #setTime(int, int, int)
	 ...
	 * 
	 * <p>
	 * Returns {@link DatatypeConstants#FIELD_UNDEFINED} if this field is not
	 * defined. When this field is not defined, the optional xs:dateTime
	 * fractional seconds field, represented by {@link #getFractionalSecond()}
	 * and {@link #getMillisecond()}, must not be defined.
	 * </p>
	 * 
	 * <p>
	 * Value constraints for this value are summarized in <a
	 * href="#datetimefield-second">second field of date/time field mapping
	 * table</a>.
	 * </p>
	 * 
	 ...
	 * fractional second value returned by {@link #getFractionalSecond()}. The
	 ...
	 * 
	 * <p>
	 * <code>null</code> is returned when this optional field is not defined.
	 * </p>
	 * 
	 * <p>
	 * Value constraints are detailed in <a href="#datetimefield-second">second
	 * field of date/time field mapping table</a>.
	 * </p>
	 * 
	 * <p>
	 * This optional field can only have a defined value when the xs:dateTime
	 * second field, represented by ({@link #getSecond()}, does not return
	 * {@link DatatypeConstants#FIELD_UNDEFINED}).
	 * </p>
	 * 
	 ...
	 * 
	 * @param year
	 *            value constraints summarized in <a
	 *            href="#datetimefield-year">year field of date/time field
	 *            mapping table</a>.
	 * 
	 * @throws IllegalArgumentException
	 *             if <code>year</code> parameter is outside value constraints
	 *             for the field as specified in <a
	 *             href="#datetimefieldmapping">date/time field mapping
	 *             table</a>.
	 */
	 ...
	 * 
	 * <p>
	 * Note: if the absolute value of the <code>year</code> parameter is less
	 * than 10^9, the eon component of the XSD year field is set to
	 * <code>null</code> by this method.
	 * </p>
	 * 
	 * @param year
	 *            value constraints are summarized in <a
	 *            href="#datetimefield-year">year field of date/time field
	 ...
	 * @param month
	 *            value constraints summarized in <a
	 *            href="#datetimefield-month">month field of date/time field
	 *            mapping table</a>.
	 * 
	 * @throws IllegalArgumentException
	 ...
	 * @param day
	 *            value constraints summarized in <a
	 *            href="#datetimefield-day">day field of date/time field mapping
	 *            table</a>.
	 * 
	 * @throws IllegalArgumentException
	 ...
	 * @param offset
	 *            value constraints summarized in <a
	 *            href="#datetimefield-timezone"> timezone field of date/time
	 *            field mapping table</a>.
	 * 
	 * @throws IllegalArgumentException
	 ...
	 * @param hour
	 *            value constraints are summarized in <a
	 *            href="#datetimefield-hour">hour field of date/time field
	 *            mapping table</a>.
	 * @param minute
	 *            value constraints are summarized in <a
	 *            href="#datetimefield-minute">minute field of date/time field
	 *            mapping table</a>.
	 * @param second
	 *            value constraints are summarized in <a
	 *            href="#datetimefield-second">second field of date/time field
	 *            mapping table</a>.
	 * 
	 * @see #setTime(int, int, int, BigDecimal)
	 * 
	...
	private void checkFieldValueConstraint(int field, int value)
		...
		if ((value < MIN_FIELD_VALUE[field] && value != DatatypeConstants.FIELD_UNDEFINED)
			 ...
			 * " for " + FIELD_NAME[field] + " field");
			 */
			throw new IllegalArgumentException("InvalidFieldValue");
		}
	}
	...
	/**
	 * <p>
	 * Set time as one unit, including the optional infinite precison fractional
	 * seconds.
	 * </p>
	 * 
	 * @param hour
	 ...
	 * to partial order relation defined in <a
	 * href="http://www.w3.org/TR/xmlschema-2/#dateTime-order">W3C XML Schema
	 * 1.0 Part 2, Section 3.2.7.3, <i>Order relation on dateTime</i></a>.
	 * </p>
	 * 
	 * <p>
	 * <code>xsd:dateTime</code> datatype field mapping to accessors of this
	 * class are defined in <a href="#datetimefieldmapping">date/time field
	 * mapping table</a>.
	 * </p>
	 * 
	 * @param rhs
	 ...
	 *         {@link DatatypeConstants#LESSER}, {@link DatatypeConstants#EQUAL}
	 *         , {@link DatatypeConstants#GREATER} or
	 *         {@link DatatypeConstants#INDETERMINATE}.
	 * 
	 * @throws NullPointerException
	 *             if <code>lhs</code> or <code>rhs</code> parameters are null.
	 */
	 ...
	 * </p>
	 */
	private XMLGregorianCalendar normalizeToTimezone(XMLGregorianCalendar cal,
			int timezone) {
	 ...
	 * 
	 * @param P
	 *            calendar instance with normalized timezone offset or having
	 *            same timezone as Q
	 * @param Q
	 *            calendar instance with normalized timezone offset or having
	 *            same timezone as P
	 ...
	 *         {@link DatatypeConstants#EQUAL}, {@link DatatypeConstants#LESSER}
	 *         , {@link DatatypeConstants#GREATER} or
	 *         {@link DatatypeConstants#INDETERMINATE}.
	 */
	...
	private static int compareField(int Pfield, int Qfield) {
		if (Pfield == Qfield) {
			...
			if (Pfield == DatatypeConstants.FIELD_UNDEFINED
				...
				// Step B. 1.3-4.
				return (Pfield < Qfield ? DatatypeConstants.LESSER
	...
	private static int compareField(BigInteger Pfield, BigInteger Qfield) {
		if (Pfield == null) {
			return (Qfield == null ? DatatypeConstants.EQUAL
	 ...
	 *         <code>compare(this,(XMLGregorianCalendar)obj) == EQUAL.</code>.
	 */
	...
	public int hashCode() {
		...
		return gc.getYear() + gc.getMonth() + gc.getDay() + gc.getHour()
				+ gc.getMinute() + gc.getSecond();
	}

	/**
	 * <p>
	 * Constructs a new XMLGregorianCalendar object by parsing its lexical
	 * string representation as defined in <a
	 * href="http://www.w3.org/TR/xmlschema-2/#dateTime-order">XML Schema 1.0
	 * Part 2, Section 3.2.[7-14].1, <i>Lexical Representation</i>.</a>
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * @param lexicalRepresentation
	 *            Lexical representation of one the 8 XML Schema calendar
	 *            datatypes.
	 * 
	 * @return <code>XMLGregorianCalendar</code> created from parsing
	 *         <code>lexicalRepresentation</code> parameter.
	 * 
	 * @throws IllegalArgumentException
	...
	/**
	 * <p>
	 * Return the lexical representation of <code>this</code> instance. The
	 ...
	 * </p>
	 * 
	 * @return XML, as <code>String</code>, representation of this
	 *         <code>XMLGregorianCalendar</code>
	 * 
	 ...
	 * to. Type is computed based on fields that are set.
	 * </p>
	 * 
	 * <table border="2" rules="all" cellpadding="2">
	 * <thead>
	 ...
	 * <i>(timezone is optional for all date/time datatypes)</i></th>
	 * </tr>
	 * </thead> <tbody>
	 * <tr>
	 * <td>Datatype</td>
	 ...
	 *         {@link DatatypeConstants#GYEAR}, {@link DatatypeConstants#GMONTH}
	 *         or {@link DatatypeConstants#GDAY}.
	 */
	public QName getXMLSchemaType() {
		...
		throw new IllegalStateException(this.getClass().getName()
				+ "#getXMLSchemaType() :" + "InvalidXGCFields");
	}
	...
	public boolean isValid() {
		...
		if (hour == 24
				&& (minute != 0 || second != 0 || (fractionalSecond != null && fractionalSecond
	 ...
	 * 
	 * <p>
	 * The computation is specified in <a
	 * href="http://www.w3.org/TR/xmlschema-2/#adding-durations-to-dateTimes"
	 * >XML Schema 1.0 Part 2, Appendix E, <i>Adding durations to
	 * dateTimes</i>></a>. <a href="#datetimefieldsmapping">date/time field
	 * mapping table</a> defines the mapping from XML Schema 1.0
	 * <code>dateTime</code> fields to this class' representation of those
	 * fields.
	 * </p>
	 * 
	 * @param duration
	...
	public void add(Duration duration) {
		...
		/*
		 * Extracted from
		 * http://www.w3.org/TR/xmlschema-2/#adding-durations-to-dateTimes to
		 * ensure implemented properly. See spec for definitions of methods used
		 * in algorithm.
		 * 
		 ...
		 * treated in the calculation as if it were the minimum allowed value in
		 * that field, however, after the calculation is concluded, the
		 * corresponding field in E is removed (set to unspecified).
		 * 
		 * Months (may be modified additionally below) temp := S[month] +
		 * D[month] E[month] := modulo(temp, 1, 13) carry := fQuotient(temp, 1,
		 * 13)
		 */
		...
		BigInteger dMonths = sanitize(
				duration.getField(DatatypeConstants.MONTHS), signum);
		...
		BigInteger carry = new BigDecimal(temp.subtract(BigInteger.ONE))
				.divide(new BigDecimal(TWELVE), BigDecimal.ROUND_FLOOR)
				.toBigInteger();

		/*
		 * Years (may be modified additionally below) E[year] := S[year] +
		 * D[year] + carry
		 */
		...
		BigInteger dYears = sanitize(
				duration.getField(DatatypeConstants.YEARS), signum);
		...
		/*
		 * Seconds temp := S[second] + D[second] E[second] := modulo(temp, 60)
		...
		BigDecimal dSeconds = DurationImpl.sanitize(
				(BigDecimal) duration.getField(DatatypeConstants.SECONDS),
				signum);
		BigDecimal tempBD = startSeconds.add(dSeconds);
		BigDecimal fQuotient = new BigDecimal(new BigDecimal(
				tempBD.toBigInteger()).divide(DECIMAL_SIXTY,
				BigDecimal.ROUND_FLOOR).toBigInteger());
		BigDecimal endSeconds = tempBD.subtract(fQuotient
				.multiply(DECIMAL_SIXTY));

		carry = fQuotient.toBigInteger();
		setSecond(endSeconds.intValue());
		BigDecimal tempFracSeconds = endSeconds.subtract(new BigDecimal(
				BigInteger.valueOf((long) getSecond())));
		...
		BigInteger dMinutes = sanitize(
				duration.getField(DatatypeConstants.MINUTES), signum);

		temp = BigInteger.valueOf(startMinutes).add(dMinutes).add(carry);
		setMinute(temp.mod(SIXTY).intValue());
		carry = new BigDecimal(temp).divide(DECIMAL_SIXTY,
				BigDecimal.ROUND_FLOOR).toBigInteger();
		...
		BigInteger dHours = sanitize(
				duration.getField(DatatypeConstants.HOURS), signum);

		temp = BigInteger.valueOf(startHours).add(dHours).add(carry);
		setHour(temp.mod(TWENTY_FOUR).intValue());
		carry = new BigDecimal(temp).divide(new BigDecimal(TWENTY_FOUR),
				BigDecimal.ROUND_FLOOR).toBigInteger();

		/*
		 * Days if S[day] > maximumDayInMonthFor(E[year], E[month]) + tempDays
		 * := maximumDayInMonthFor(E[year], E[month]) else if S[day] < 1 +
		 * tempDays := 1 else + tempDays := S[day] E[day] := tempDays + D[day] +
		 * carry START LOOP + IF E[day] < 1 # E[day] := E[day] +
		 * maximumDayInMonthFor(E[year], E[month] - 1) # carry := -1 + ELSE IF
		 * E[day] > maximumDayInMonthFor(E[year], E[month]) # E[day] := E[day] -
		 * maximumDayInMonthFor(E[year], E[month]) # carry := 1 + ELSE EXIT LOOP
		 * + temp := E[month] + carry + E[month] := modulo(temp, 1, 13) +
		 * E[year] := E[year] + fQuotient(temp, 1, 13) + GOTO START LOOP
		 */
		BigInteger tempDays;
		int startDay = getDay();
		...
		BigInteger dDays = sanitize(duration.getField(DatatypeConstants.DAYS),
				signum);
		...
		while (true) {
			if (endDays.compareTo(BigInteger.ONE) < 0) {
				...
				if (month >= 2) {
					mdimf = BigInteger.valueOf(maximumDayInMonthFor(
							getEonAndYear(), getMonth() - 1));
				} else {
					// roll over to December of previous year
					mdimf = BigInteger.valueOf(maximumDayInMonthFor(
							getEonAndYear().subtract(
									BigInteger.valueOf((long) 1)), 12));
				}
				endDays = endDays.add(mdimf);
				monthCarry = -1;
			} else if (endDays
					.compareTo(BigInteger.valueOf(maximumDayInMonthFor(
							getEonAndYear(), getMonth()))) > 0) {
				endDays = endDays.add(BigInteger.valueOf(-maximumDayInMonthFor(
						getEonAndYear(), getMonth())));
				monthCarry = 1;
			} else {
				break;
			}
		...
		// set fields that where undefined before this addition, back to
		// undefined.
	...
	private static int maximumDayInMonthFor(BigInteger year, int month) {
		if (month != DatatypeConstants.FEBRUARY) {
			...
			if (year.mod(FOUR_HUNDRED).equals(BigInteger.ZERO)
					|| (!year.mod(HUNDRED).equals(BigInteger.ZERO) && year.mod(
							FOUR).equals(BigInteger.ZERO))) {
				// is a leap year.
				return 29;
			} else {
				return DaysInMonth.table[month];
	 ...
	 * 
	 * <p>
	 * When <code>this</code> instance has an undefined field, this conversion
	 * relies on the <code>java.util.GregorianCalendar</code> default for its
	 * corresponding field. A notable difference between XML Schema 1.0
	 * date/time datatypes and <code>java.util.GregorianCalendar</code> is that
	 * Timezone value is optional for date/time datatypes and it is a required
	 * field for <code>java.util.GregorianCalendar</code>. See javadoc for
	 * <code>java.util.TimeZone.getDefault()</code> on how the default is
	 * determined. To explicitly specify the <code>TimeZone</code> instance, see
	 ...
	 * <code>java.util.GregorianCalendar</code></th>
	 * </tr>
	 * </thead> <tbody>
	 * <tr>
	 * <th><code>java.util.GregorianCalendar</code> field</th>
	 ...
	 * <tr>
	 * <th><code>ERA</code></th>
	 * <th>{@link #getEonAndYear()}
	 * <code>.signum() < 0 ? GregorianCalendar.BC : GregorianCalendar.AD</code></th>
	 * </tr>
	 * <tr>
	 ...
	 * <code>java.util.GregorianCalendar(timeZone,Locale.getDefault())</code>.</li>
	 * <li>Initialize all GregorianCalendar fields by calling {(@link
	 * GegorianCalendar#clear()}.</li>
	 ...
	 * SECOND and MILLISECOND are set using the method
	 * <code>Calendar.set(int,int)</code></li>
	 * </ul>
	 * </p>
	 * 
	 * @see #toGregorianCalendar(TimeZone, Locale,
	...
	/**
	 * <p>
	 * Convert <code>this</code> along with provided parameters to
	 * <code>java.util.GregorianCalendar</code> instance.
	 * </p>
	 * 
	 * <p>
	 * Since XML Schema 1.0 date/time datetypes has no concept of timezone ids
	 * or daylight savings timezone ids, this conversion operation allows the
	 * user to explicitly specify one with <code>timezone</code> parameter.
	 * </p>
	 * 
	 * <p>
	 * To compute the return value's <code>TimeZone</code> field,
	 * <ul>
	 * <li>when parameter <code>timeZone</code> is non-null, it is the timezone
	 * field.</li>
	 * <li>else when
	 * <code>this.getTimezone() != DatatypeConstants.FIELD_UNDEFINED</code>,
	 * create a <code>java.util.TimeZone</code> with a custom timezone id using
	 * the <code>this.getTimezone()</code>.</li>
	 * <li>else when
	 * <code>defaults.getTimezone() != DatatypeConstants.FIELD_UNDEFINED</code>,
	 * create a <code>java.util.TimeZone</code> with a custom timezone id using
	 ...
	 *            for this instance is DatatypeConstants.FIELD_UNDEFINED or
	 *            null. If <code>defaults</code>is <code>null</code> or a field
	 *            within the specified <code>defaults</code> is undefined, just
	 *            use <code>java.util.GregorianCalendar</code> defaults.
	...
	public GregorianCalendar toGregorianCalendar(TimeZone timezone,
			...
			if (defaults != null) {
				...
				if (defaultYear != DatatypeConstants.FIELD_UNDEFINED) {
					if (defaults.getEon() == null) {
						result.set(Calendar.ERA,
								defaultYear < 0 ? GregorianCalendar.BC
										: GregorianCalendar.AD);
						result.set(Calendar.YEAR, Math.abs(defaultYear));
					} else {
						final BigInteger defaultEonAndYear = defaults
								.getEonAndYear();
						result.set(
								Calendar.ERA,
								defaultEonAndYear.signum() == -1 ? GregorianCalendar.BC
										: GregorianCalendar.AD);
						result.set(Calendar.YEAR, defaultEonAndYear.abs()
								.intValue());
					}
				}
			}
		...
		if (month != DatatypeConstants.FIELD_UNDEFINED) {
			...
			// use default if set
			final int defaultMonth = (defaults != null) ? defaults.getMonth()
		...
		if (day != DatatypeConstants.FIELD_UNDEFINED) {
			...
			// use default if set
			final int defaultDay = (defaults != null) ? defaults.getDay()
					: DatatypeConstants.FIELD_UNDEFINED;
		...
		if (hour != DatatypeConstants.FIELD_UNDEFINED) {
			...
			// use default if set
			int defaultHour = (defaults != null) ? defaults.getHour()
					: DatatypeConstants.FIELD_UNDEFINED;
		...
		if (minute != DatatypeConstants.FIELD_UNDEFINED) {
			...
			// use default if set
			final int defaultMinute = (defaults != null) ? defaults.getMinute()
					: DatatypeConstants.FIELD_UNDEFINED;
		...
		if (second != DatatypeConstants.FIELD_UNDEFINED) {
			...
			// use default if set
			final int defaultSecond = (defaults != null) ? defaults.getSecond()
					: DatatypeConstants.FIELD_UNDEFINED;
		...
		if (fractionalSecond != null) {
			...
			// use default if set
			final BigDecimal defaultFractionalSecond = (defaults != null) ? defaults
					.getFractionalSecond() : null;
	 ...
	 * 
	 * <p>
	 * If timezone field is defined for this instance, returns TimeZone
	 * initialized with custom timezone id of zoneoffset. If timezone field is
	 * undefined, try the defaultZoneoffset that was passed in. If
	 * defaultZoneoffset is DatatypeConstants.FIELD_UNDEFINED, return default
	...
	public Object clone() {
		...
		return new XMLGregorianCalendarImpl(getEonAndYear(), this.month,
				this.day, this.hour, this.minute, this.second,
				this.fractionalSecond, this.timezone);
	}
	 ...
	 * 
	 * <p>
	 * Set all int fields to {@link DatatypeConstants#FIELD_UNDEFINED} and
	...
	private final class Parser {
		 ...
		 * <code>XMLGregorianCalendar</code> value, an
		...
		private int parseInt(int minDigits, int maxDigits)
			...
			// // if the value is too long for int, NumberFormatException is
			// thrown
	 ...
	 * @param nDigits
	 *            The field will be printed by using at least this number of
	 *            digits. For example, 5 will be printed as "0005" if
	 *            nDigits==4.
	 */
	 ...
	 * 
	 * <p>
	 * Due to a behavior change in the {@link BigDecimal#toString()} method in
	 * JDK1.5, this had to be implemented here.
	 * </p>
	 * 
	 * @param bd
	...
	static BigInteger sanitize(Number value, int signum) {
		...
		return (signum < 0) ? ((BigInteger) value).negate()
				: (BigInteger) value;
	}

	/**
	 * <p>
	 * <code>reset()</code> is designed to allow the reuse of existing
	 * <code>XMLGregorianCalendar</code>s thus saving resources associated with
	 * the creation of new <code>XMLGregorianCalendar</code>s.
	 * </p>
	 */
	public void reset() {
		eon = orig_eon;
	...
	/**
	 * Writes {@link XMLGregorianCalendar} as a lexical representation for
	 * maximum future compatibility.
	 * 
	 * @return An object that encapsulates the string returned by
	 *         <code>this.toXMLFormat()</code>.
	 */
